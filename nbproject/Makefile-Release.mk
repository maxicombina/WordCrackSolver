...
${OBJECTDIR}/src/BoardManager.o: src/BoardManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/BoardManager.o src/BoardManager.cpp
...
${OBJECTDIR}/src/ProcessedWord.o: src/ProcessedWord.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ProcessedWord.o src/ProcessedWord.cpp
